...
public enum NMRangePointerShape: Int {
    case triangle = 0, square
}


public class NMRangePointerView: UIView {

    var shape: NMRangePointerShape = .triangle
    var sideOffset = kDefaultPointerLayerSideOffset
    var fillColor: UIColor = UIColor(red: 0/255, green: 0/255, blue: 238/255, alpha: 1.0)
